...
interface LoginPageProps {
  onLogin: (username: string, examType: ExamType, role: UserRole) => void;
}
...
export function LoginPage({ onLogin }: LoginPageProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (username && password) {
      onLogin(username, examType, userRole);
    }
  };
            ...
            <div className="space-y-3">
              ...
              <RadioGroup value={userRole} onValueChange={(value) => setUserRole(value as UserRole)}>
                <div className={`flex items-center space-x-2 p-3 border rounded-lg transition-all ${
                  ...
                  <RadioGroupItem value="student" id="student" className="border-gray-400" />
                  <Label htmlFor="student" className="flex-1 cursor-pointer text-gray-800">
                ...
                <div className={`flex items-center space-x-2 p-3 border rounded-lg transition-all ${
                  ...
                  <RadioGroupItem value="teacher" id="teacher" className="border-gray-400" />
                  <Label htmlFor="teacher" className="flex-1 cursor-pointer text-gray-800">
                    <div className="flex items-center gap-2">
                      <span>👨‍🏫</span>
                      <span>Teacher</span>
                    </div>
